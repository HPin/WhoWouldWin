...
class CustomTabBar: ESTabBarController {
    ...
    override func viewDidLoad() {
        ...
        tabBar.backgroundImage = UIImage(named: "backgroundtb")
        ...
        v3.tabBarItem = ESTabBarItem.init(ExampleIrregularityContentView(), title: nil, image: UIImage(named: "mainicontb"), selectedImage: UIImage(named: "mainicontb"), tag: 2)
